package com.example.wanqian.utitls.baiduVioce.control;
...
import com.example.wanqian.utitls.baiduVioce.MainHandlerConstant;
...
public class MySyntherizer implements MainHandlerConstant {
    ...
    public void release() {
        ...
        if (!isInitied) {
            // 这里报错是因为连续两次 new MySyntherizer 必须第一次new 之后，调用release方法
            throw new RuntimeException("TTS 还未初始化");
        }
