...
public class ImagePicker {
     ...
     * @return
     */
    public ImagePicker showVideoCamera(boolean showVideoCamera) {
        ConfigManager.getInstance().setShowVideoCamera(showVideoCamera);
        return mImagePicker;
    }
    ...
    public ImagePicker setMaxVideo(int maxVideo) {
        ConfigManager.getInstance().setMaxVideo(maxVideo);
        return mImagePicker;
    }
    ...
    public void start(Activity activity, int requestCode,boolean camera) {
        Intent intent = new Intent(activity, ImagePickerActivity.class);
