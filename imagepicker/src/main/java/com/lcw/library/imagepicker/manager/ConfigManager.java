...
public class ConfigManager {
    ...
    private boolean showVideoCamera;//是否显示VideoItem，默认不显示
    ...
    private int maxVideo = 1; // 最大选择视频数量，默认1
    ...
    public boolean isShowVideoCamera() {
        return showVideoCamera;
    }

    public void setShowVideoCamera(boolean showVideoCamera) {
